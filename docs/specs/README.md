...
| ~~Anthropic/暗夜/海风等命名主题预设的具体色值未定义~~ | 已采集 | dogapi.cc 与 linkapi.ai 样式表色值已写入 `ThemePresets`；未收入「超大字体简易」 | [spec-settings-master-detail-and-theme-presets](./visual-theme/spec-settings-master-detail-and-theme-presets[DONE].md) |
